...
#cb.plot()
list_of_jobs = ['Data/IDM/GX10312025_IDM_Ta14_10cm_000.Spe',
                ]
...
summed_spectra.saveas("Spectroscopy/Ta_peak_summary/GX10312025_IDM_Ta14_10cm_jobs_peak_summary.csv")
sp.summarize()
