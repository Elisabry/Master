...
sp = ci.Spectrum('Data/IDM/AD09232025_Cu11_45cm_IDM.Spe')
sp.cb = cb
sp.isotopes = [
...
sp.saveas("Spectroscopy/Cu_peak_summary/AD09232025_Cu11_45cm_IDM_peak_summary.csv")


# "62ZN","63ZN","65ZN", "56CO","58CO"