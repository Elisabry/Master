...
# --- User input ---
spectra_files = [
    'Spectroscopy/Ni_peak_summary/AS09242025_Ni12_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/CX09252025_Ni12_25cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/GH10092025_Det2_Ni12_10cm_jobs_peak_summary.csv',
]
...
df_out.to_csv('Activity/Activity_data/Ni12_A0.csv', index=False)
print("Saved A0 results to: Activity/Activity_data/Ni12_A0.csv")