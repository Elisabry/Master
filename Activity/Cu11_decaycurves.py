...
# --- User input ---
spectra_files = [
    'Spectroscopy/Cu_peak_summary/AD09232025_Cu11_45cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/AK09232025_Cu11_40cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/BM09242025_Cu11_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/BP09242025_Cu11_10cm_LEPS_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/DT09252025_Cu11_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/EW09272025_Cu11_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/GU10212025_Det2_Cu11_10cm_jobs_peak_summary.csv',
]

isotopes_list = ['62ZN', '63ZN', '65ZN', '56CO', '58CO']

foil_name = 'Cu11'                                               #ENDRE NAVNET HER!
...
df_out.to_csv('Activity/Activity_data/Cu11_A0.csv', index=False)                    #ENDRE NAVNET HER!
print("Saved A0 results to: Activity/Activity_data/Cu11_A0.csv")                    #ENDRE NAVNET HER!
# ...existing code...