...
df_out.to_csv('Activity/Activity_data/Cu06_A0.csv', index=False)                    #ENDRE NAVNET HER!
print("Saved A0 results to: Activity/Activity_data/Cu06_A0.csv")                    #ENDRE NAVNET HER!
# ...existing code...
