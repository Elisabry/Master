...
# --- User input ---
spectra_files = [
    'Spectroscopy/Cu_peak_summary/AC09232025_Cu10_52cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/AJ09232025_Cu10_45cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/BD09242025_Cu10_50cm_DET2_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/BL09242025_Cu10_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/DU09252025_Cu10_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/EX09272025_Cu10_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/GN10212025_IDM_Cu10_10cm_jobs_peak_summary.csv',
]

isotopes_list = ['62ZN', '63ZN', '65ZN', '56CO', '58CO']

foil_name = 'Cu10'                                               #ENDRE NAVNET HER!
...
df_out.to_csv('Activity/Activity_data/Cu10_A0.csv', index=False)                    #ENDRE NAVNET HER!
print("Saved A0 results to: Activity/Activity_data/Cu10_A0.csv")                    #ENDRE NAVNET HER!
# ...existing code...