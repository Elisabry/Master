...
# --- User input ---
spectra_files = [
    'Spectroscopy/Cu_peak_summary/AG09232025_Cu14_52cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/AN09232025_Cu14_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/BP09242025_Cu14_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/DQ09252025_Cu14_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/ET09262025_Cu14_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/GL10172025_IDM_Cu14_10cm_jobs_peak_summary.csv'
]

isotopes_list = ['62ZN', '63ZN', '65ZN', '56CO', '58CO']

foil_name = 'Cu14'                                               #ENDRE NAVNET HER!
...
df_out.to_csv('Activity/Activity_data/Cu14_A0.csv', index=False)                    #ENDRE NAVNET HER!
print("Saved A0 results to: Activity/Activity_data/Cu14_A0.csv")                    #ENDRE NAVNET HER!
# ...existing code...