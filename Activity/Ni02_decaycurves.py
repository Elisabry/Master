...
# --- User input ---
spectra_files = [
    'Spectroscopy/Ni_peak_summary/CG09242025_Ni02_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/DI09252025_Ni02_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/GS10182025_Det2_Ni02_10cm_jobs_peak_summary.csv',
]
...
df_out.to_csv('Activity/Activity_data/Ni02_A0.csv', index=False)
print("Saved A0 results to: Activity/Activity_data/Ni02_A0.csv")