...
# --- User input ---
spectra_files = [
    'Spectroscopy/Cu_peak_summary/AE09232025_Cu12_52cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/AL09232025_Cu12_40cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/BN09242025_Cu12_25cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/DS09252025_Cu12_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/EV09272025_Cu12_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/GM10182025_IDM_Cu12_10cm_jobs_peak_summary.csv'
]

isotopes_list = ['62ZN', '63ZN', '65ZN', '56CO', '58CO']

foil_name = 'Cu12'                                               #ENDRE NAVNET HER!
...
df_out.to_csv('Activity/Activity_data/Cu12_A0.csv', index=False)                    #ENDRE NAVNET HER!
print("Saved A0 results to: Activity/Activity_data/Cu12_A0.csv")                    #ENDRE NAVNET HER!
# ...existing code...