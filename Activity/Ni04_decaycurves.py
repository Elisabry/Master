...
# --- User input ---
spectra_files = [
    'Spectroscopy/Ni_peak_summary/CI09242025_Ni04_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/DK09252025_Ni04_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/GQ10162025_Det2_Ni04_10cm_jobs_peak_summary.csv',
]
...
df_out.to_csv('Activity/Activity_data/Ni04_A0.csv', index=False)
print("Saved A0 results to: Activity/Activity_data/Ni04_A0.csv")