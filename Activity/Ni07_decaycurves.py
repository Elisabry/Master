...
# --- User input ---
spectra_files = [
    'Spectroscopy/Ni_peak_summary/CL09242025_Ni07_25cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/DN09252025_Ni07_30cm_IDM_peak_summary.csv',
]
...
df_out.to_csv('Activity/Activity_data/Ni07_A0.csv', index=False)
print("Saved A0 results to: Activity/Activity_data/Ni07_A0.csv")