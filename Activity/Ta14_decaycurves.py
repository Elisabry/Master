...
# --- User input ---
spectra_files = [
    'Spectroscopy/Ta_peak_summary/AG09232025_Ta14_10cm_LEPS_peak_summary.csv',
    'Spectroscopy/Ta_peak_summary/GJ10132025_IDM_Ta14_10cm_jobs_peak_summary.csv',
    'Spectroscopy/Ta_peak_summary/GY11032025_IDM_Ta14_10cm_peak_summary.csv'
]                      
...
foil_name = 'Ta14'                                               #ENDRE NAVNET HER!
...
df_out.to_csv('Activity/Activity_data/Ta14_A0.csv', index=False)                    #ENDRE NAVNET HER!
print("Saved A0 results to: Activity/Activity_data/Ta14_A0.csv")                    #ENDRE NAVNET HER!
# ...existing code...
