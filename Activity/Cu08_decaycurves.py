...
# --- User input ---
spectra_files = [
    'Spectroscopy/Cu_peak_summary/BJ09242025_Cu08_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/DW09252025_Cu08_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/EZ09272025_Cu08_10cm_IDM_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/GO10212025_IDM_Cu08_10cm_jobs_peak_summary.csv',
    'Spectroscopy/Cu_peak_summary/AA09232025_Cu08_40cm_IDM_peak_summary.csv'
]
...
df_out.to_csv('Activity/Activity_data/Cu08_A0.csv', index=False)
print("Saved A0 results to: Activity/Activity_data/Cu08_A0.csv")
# ...existing code...