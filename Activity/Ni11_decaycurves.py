...
# --- User input ---
spectra_files = [
    'Spectroscopy/Ni_peak_summary/AR09242025_Ni11_30cm_IDM_peak_summary.csv',
    'Spectroscopy/Ni_peak_summary/CW09252025_Ni11_25cm_IDM_peak_summary.csv',
...
df_out.to_csv('Activity/Activity_data/Ni11_A0.csv', index=False)
print("Saved A0 results to: Activity/Activity_data/Ni11_A0.csv")